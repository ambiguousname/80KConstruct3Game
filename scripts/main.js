...
async function OnBeforeProjectStart(runtime)
{
	...
	runtime.objects.Enemy.getAllInstances().forEach(function(e){
		...
		switch(e.instVars.EnemyType){
			case "Jumper": enemyClass = Jumper; break; case "Digger": enemyClass = Digger; break; case "Destroyer": enemyClass = Destroyer; break; case "Whip": enemyClass = Whip; break; case "AnimalHandler": enemyClass = AnimalHandler; break; case "BossDuplicate": enemyClass = BossDuplicate; break;
		}
